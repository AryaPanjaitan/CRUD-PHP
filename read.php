...
<body>
      ...
      <!-- form data awal -->
      <h2 class="text-center m-5" style="color:#A91D3A;"><b>DATA YANG TERSIMPAN</b></h2>
                        ...
                        while ($data = mysqli_fetch_assoc($q)) {
                              ...
                              <tr>
                                    ...
                                    <td>
                                          ...
                                          <a class="btn btn-warning" href="update.php?nim=<?= $data['nim'] ?>"><b
                                                      class="text-white"><i class="bi bi-pencil-square"></i>
                                                      Edit</b></a>
                                          <a class="btn btn-danger" href="delete.php?nim=<?= $data['nim'] ?>"><b
                                                      class="text-white"><i class="bi bi-trash"></i>
                                                      Delete</b></a>
                                    </td>
                              </tr>
                              <?php $no++;
